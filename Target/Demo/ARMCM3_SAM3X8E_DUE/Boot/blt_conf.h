...
/* DONE ##Boot Set the frequency of the crystal oscillator that provides the clock
 * signal that drives the microcontroller. Specify the value in kHz. 
 */
#define BOOT_CPU_XTAL_SPEED_KHZ          (140000)
/** \brief Desired system speed. */
/* DONE ##Boot Set the system frequency of the microcontroller system clock. Specify the
...
/* DONE ##Boot Configure the CPU's endian mode. This is hardware specific and should be
...
#define BOOT_COM_CAN_TX_MSG_ID          (0x7E1 /*| 0x80000000*/) // Overwrite per CAN0.h
/** \brief Configure number of bytes in the target->host CAN message. */
#define BOOT_COM_CAN_TX_MAX_DATA        (8)
/** \brief Configure CAN message ID host->target. */
#define BOOT_COM_CAN_RX_MSG_ID          (0x667 /*| 0x80000000*/) // Overwrite per CAN0.h
